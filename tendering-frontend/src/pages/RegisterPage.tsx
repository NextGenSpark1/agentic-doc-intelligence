      ...
      <div className="min-h-screen flex items-center justify-center bg-canvas px-6">
        <div className="w-full max-w-sm text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-navy/10 mb-5">
            <Lock size={22} className="text-navy/50" />
          </div>
          <h1 className="text-xl font-semibold text-text mb-2">Invitation only</h1>
          <p className="text-sm text-text-mute mb-6 leading-relaxed max-w-xs mx-auto">
            Tendering Intelligence is a closed platform. Ask your organisation admin to send you an invitation link.
          </p>
          <Link
            to="/login"
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-navy-deep flex-col justify-between p-12 relative overflow-hidden select-none">
        <div className="absolute inset-0 opacity-[0.06] pointer-events-none">
          <svg width="100%" height="100%">
            <defs>
              <pattern id="reg-grid" x="0" y="0" width="48" height="48" patternUnits="userSpaceOnUse">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/50 text-sm leading-relaxed max-w-xs">
            Join your team on Tendering Intelligence — AI-extracted requirements, compliance tracking, and bid decisions in one place.
          </p>
        </div>
          ...
          {done ? (
              ...
              <p className="text-sm text-text-mute mb-6 max-w-xs mx-auto leading-relaxed">
                ...
                {inviteToken && (
                  <span className="block mt-2 text-teal font-medium">
                    After signing in, you'll be redirected to complete your invitation.
                  </span>
                )}
              </p>
              <button
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-sm text-text-mute">Complete your invitation to get started</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <button type="button" onClick={() => setShowPass(previous => !previous)}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={confirm}
                      onChange={inputEvent => setConfirm(inputEvent.target.value)}
