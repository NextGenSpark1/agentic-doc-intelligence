  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 96px)' }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className="bg-panel border-r border-border flex flex-col shrink-0"
          style={{ width: 240 }}
        >
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="flex flex-col gap-0.5 p-2">
              {docsLoading && (
                <p className="text-xs text-text-mute px-2 py-2">Loading…</p>
              )}
          ...
          <div className="px-4 py-3 border-t border-border shrink-0 flex flex-col gap-1">
            {uploadError && (
              <p className="text-[10px] text-red leading-tight break-words">{uploadError}</p>
            )}
