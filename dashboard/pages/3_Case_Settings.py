...
# Settings page — case configuration and app preferences placeholder.
# When connected to Supabase this form will read/write the cases table.
...
.nav-item { display:block; padding:8px 20px; font-size:13px; font-weight:500; color:#525862; cursor:pointer; border-left:2px solid transparent; }
...
.field-textarea { background:#F6F7F9; border:1px solid #D5DAE1; border-radius:7px; padding:10px 13px; font-size:13px; color:#2A2E35; font-family:'IBM Plex Sans',sans-serif; min-height:80px; line-height:1.55; }
...
<div class="section-desc">Core metadata for INV-2026-0047. These fields will update the case record in Supabase once connected.</div>
</div>
...
<div class="field-value">Ministry of Public Works — Infrastructure Procurement</div>
<div class="field-meta">Displayed in the Cases list and all reports</div>
</div>
<div>
<div class="field-label">Case Type</div>
<div class="field-value-row"><span>Procurement Fraud</span><span style="color:#878E99;font-size:11px;">▾</span></div>
<div class="field-meta">Used to select extraction schema</div>
</div>
<div>
<div class="field-label">Lead Investigator</div>
<div class="field-value">S. Kowalski</div>
</div>
<div>
...
<div class="field-textarea">Suspected irregular award of infrastructure contracts to shell companies with ties to senior ministry officials. Pattern of split invoicing and inflated valuations identified across Q2–Q4 2024 procurement cycles.</div>
</div>
</div>
</div>
<div class="btn-row">
